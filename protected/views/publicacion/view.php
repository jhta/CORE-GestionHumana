...
<div class="column col-sm-8 col-sm-offset-2 col-xs-12 contenedor-post"  id="main">
    <div class="padding">
        ...
        echo CHtml::link($sisas,array('publicacion/index'),array('class'=>'btn pull-left btn-primary'));
            ...
            <button class="btn btn-primary pull-right" id="delete"style="margin-right:10px; " data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-trash" >Eliminar</span></button>
          </div>
